...
class PaymentPostingDetailController 
{
    ...
    def addDetail() {
        ...
        def op = Inv.lookupOpener('edit:posting:fix:detail:create', [handler: handler, payment: entity]);
        if (!op) return null;
        return op;
    }
    ...
    def editDetail() {
        ...
        def op = Inv.lookupOpener('edit:posting:fix:detail:edit', [entity: selectedItem, handler: handler]);
        if (!op) return null;
        return op;
    }
}

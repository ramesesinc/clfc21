...
public class ProductTypePage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xPanel1.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 5));
        xPanel1.setPreferredSize(new java.awt.Dimension(150, 354));
        xPanel1.setLayout(new java.awt.BorderLayout());

        xList1.setDynamic(true);
        xList1.setExpression("${item.caption}");
        xList1.setHandler("optionListHandler");

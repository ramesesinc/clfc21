...
class CashExchangeController extends CRUDController 
{
    ...
    Map createPermission = [domain: 'TREASURY', role: 'CASHIER,ACCT_ASSISTANT'];
    Map editPermission = [domain: 'TREASURY', role: 'CASHIER,ACCT_ASSISTANT'];
    
    boolean allowApprove = false;
    boolean allowDelete = false;
    boolean allowEdit = true;
    
    def prevbreakdown, prevcashout, prevcashin;
    ...
    void beforeCancel() {
        ...
        if (prevcashout) {
            entity.cashout = prevcashout;
        }
        if (prevcashin) {
            entity.cashin = prevcashin;
        }
    }

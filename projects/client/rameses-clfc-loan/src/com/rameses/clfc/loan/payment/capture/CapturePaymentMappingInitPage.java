...
public class CapturePaymentMappingInitPage extends javax.swing.JPanel {

    /**
     * Creates new form CapturePaymentMappingInitPage
     */
    public CapturePaymentMappingInitPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xComboBox2.setDepends(new String[] {"date", "collector"});
        xComboBox2.setDynamic(true);
        xComboBox2.setExpression("${item.name}");
        xComboBox2.setItems("collectionList");

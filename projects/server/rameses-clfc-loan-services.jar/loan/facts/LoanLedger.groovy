...
public class LoanLedger
{
	...
	Date currentdate;
	int noofdaysfromreleasedate
	int noofmonthsfromreleasedate;
	int noofyearsfromreleasedate;
	...
	public LoanLedger( o ) {
		...
		noofdaysfromreleasedate = Days.daysBetween(start, end).getDays();
		noofmonthsfromreleasedate = Months.monthsBetween(start, end).getMonths();
		noofyearsfromreleasedate = Years.yearsBetween(start, end).getYears();

...
public class XAppRunningTimeUtil {

	private static XAppRunningTimeUtil instance;
...
//	private int elapsedSeconds = 0;
	...
	public static XAppRunningTimeUtil getInstance() {
		if (instance == null) {
			instance = new XAppRunningTimeUtil();
		}

...
//			}
			...
			private void runImpl() throws Exception {
				...
				String str = ApplicationUtil.formatDate(Platform.getApplication().getServerDate(), "MMM dd, yyyy");
				billdate += str;
//				
				UserProfile profile = SessionContext.getProfile();
				String collectorid = (profile != null? profile.getUserId() : "");
				
				List<Map> colgroups = new ArrayList<Map>();

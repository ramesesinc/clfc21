...
public class XCancelledBillingCheckerService {
...
//	private LoanPostingService service = new LoanPostingService();
	...
	public XCancelledBillingCheckerService(ApplicationImpl app) {
		this.app = app;
	}
	...
	private void createTask() {
		actionTask = new Task() {
			...
			public void run() {
				...
				try {
					list = collectionGroup.getAllCollectionBilling();
			...
			private void removeBillingDetail( Map data ) throws Exception {
				...
				if (itemid != null && !itemid.equals("")) {
					...
					try {
						...
						appdb.rawQuery( sb.toString(), new String[]{} );
...
//			private void xremoveBillingDetail(Map data) throws Exception {
...
//			private void xremoteBillingDetailImpl(SQLTransaction clfcdb, Map data) throws Exception {
//				 
//				String itemid = "";
//				if (data.containsKey("objid")) {
//					itemid = data.get("objid").toString();

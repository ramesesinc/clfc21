...
//				appdbsb.append( sql );
			...
			if (!proxy.isEmpty()) {
				...
				params.put("description", collection.get("name").toString());
...
//				appdbsb.append( sql );
			...
			if (data.containsKey("list")) {
				billings = (List<Map>) data.get("list");
			}
...
//						appdbsb.append( sql );
			...
			ApplicationUtil.println("DownloadSpecialCollectionController", "sql params " + sqlParams);

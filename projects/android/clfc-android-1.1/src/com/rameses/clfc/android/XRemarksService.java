...
//	private LoanPostingService svc = new LoanPostingService();
	...
	public XRemarksService(ApplicationImpl app) {
		this.app = app;
	...
	private void createTask() {
		actionTask = new Task() {
			...
			private void runImpl() throws Exception {
				...
				List<Map> list = remarksservicedb.getForUploadRemarks( SIZE );
				...
				boolean hasUnpostedRemarks = remarksservicedb.hasUnpostedRemarks();

...
public class XCollectionSheetListActivity extends ControlActivity 
{
...
//				tv_str.setTextColor(getResources().getColor(R.color.blue));
	...
	private View.OnClickListener captureOnClickListener = new View.OnClickListener() {
		public void onClick(View v) {
			...
			Intent intent = new Intent(XCollectionSheetListActivity.this, CapturePaymentActivity.class);
...
//				Intent intent = new Intent(CollectionSheetListActivity.this, XCollectionSheetInfoActivity.class);
				Intent intent = new Intent(XCollectionSheetListActivity.this, CollectionSheetInfoMainActivity.class);
				intent.putExtra("objid", MapProxy.getString(cs, "objid"));
				startActivity(intent);
			} else if (isfirstbill == 1) {
				final String[] items = {"Schedule", "Overpayment"};
				UIDialog dialog = new UIDialog(XCollectionSheetListActivity.this) {
...
//				totalcs = collectionSheet.getCountByGroup(itemid);
				...
				t.printStackTrace();
				UIDialog.showMessage(t, XCollectionSheetListActivity.this);
			}
...
//			println("collection sheets " + collectionSheets);
	...
	private void showCollectionSheetInfo(Map map) {
		Intent intent = new Intent(XCollectionSheetListActivity.this, XCollectionSheetInfoActivity.class);

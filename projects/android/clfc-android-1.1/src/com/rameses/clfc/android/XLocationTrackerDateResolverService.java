...
public class XLocationTrackerDateResolverService {

	private final String DBNAME = "clfctracker.db"; 
	private ApplicationImpl app;
	private XDBLocationTracker trackerSvc = new XDBLocationTracker();
	private boolean serviceStarted = false;
	private Task actionTask;
	
	public XLocationTrackerDateResolverService(ApplicationImpl app) {
		this.app = app;
	}
...
//						public void run() {
//							if (app.broadcastLocationSvc.getServiceStarted() == false) {

...
SELECT q.*,
	...
	END AS borrower
FROM (
	SELECT a.borrower_name AS bname, a.appno, a.objid AS appid, c.dtreleased, a.loanamount, a.apptype,IFNULL(le.totalcharges,0.0) as totalcharges , IFNULL(le.netamount,0.0) as netamount,
